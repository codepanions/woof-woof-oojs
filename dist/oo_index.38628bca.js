...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var dogForm = document.querySelector('#dog-form');
  ...
  dogForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var updateDogId = e.target.dataset.id; // We don't need to parseInt because we are interpolating the id into a URL string.

    fetch("http://localhost:3000/pups/".concat(updateDogId), {
      method: 'PATCH',
      headers: {
